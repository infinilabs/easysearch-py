...
from easysearch.serializer import (
    JSONSerializer,
    Deserializer,
    DEFAULT_SERIALIZERS,
    TextSerializer,
)
from easysearch.exceptions import SerializationError, ImproperlyConfigured
...
class TestJSONSerializer(TestCase):
    ...
    def test_serializes_numpy_ndarray(self):
        ...
        # This isn't useful for Easysearch, just want to make sure it works.
        self.assertEqual(
            '{"d":[[0,0],[0,0]]}',
