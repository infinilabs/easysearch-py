...
import os
import time
from easysearch import Easysearch, NotFoundError, RequestError
...
def wipe_cluster(client):
    ...
    try:
        ...
        if isinstance(client, AsyncEasysearch):
            client = Easysearch(client.transport.hosts, verify_certs=False)
