...
class EnrichClient(NamespacedClient):
    ...
    async def delete_policy(self, name, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/delete-enrich-policy-api.html>`_
    ...
    async def execute_policy(self, name, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/execute-enrich-policy-api.html>`_
    ...
    async def get_policy(self, name=None, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/get-enrich-policy-api.html>`_
    ...
    async def put_policy(self, name, body, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/put-enrich-policy-api.html>`_
    ...
    async def stats(self, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/enrich-stats-api.html>`_
        """
        return await self.transport.perform_request(
