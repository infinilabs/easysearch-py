...
class IngestClient(NamespacedClient):
    ...
    def get_pipeline(self, id=None, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/get-pipeline-api.html>`_
    ...
    def put_pipeline(self, id, body, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/put-pipeline-api.html>`_
    ...
    def delete_pipeline(self, id, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/delete-pipeline-api.html>`_
    ...
    def simulate(self, body, id=None, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/simulate-pipeline-api.html>`_
    ...
    def processor_grok(self, params=None, headers=None):
        ...
        `<https://easysearch.cn/guide/en/easysearch/reference/7.10/grok-processor.html#grok-processor-rest-get>`_
        """
        return self.transport.perform_request(
